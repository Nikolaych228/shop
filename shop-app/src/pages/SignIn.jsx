...
import { checkRole, login } from '../api/auth';
        ...
        <div class="md:flex w-full">
            ...
            <div class="w-full md:w-1/2 py-10 px-5 md:px-10">
                <div class="text-center mb-10">
                    ...
                    <p>Введите данные о себе чтобы войти</p>
                    {helperText ? 
                ...
                <div>
                    ...
                    <div class="flex -mx-3">
                        <div class="w-full px-3 mb-5">
                            <button onClick={loginHandler} disabled={loading} class="block w-full max-w-xs mx-auto bg-orange-500 hover:bg-orange-700 focus:bg-orange-700 text-white rounded-lg px-3 py-3 font-semibold">{loading ? 
                            ...
                            <div className="w-full flex justify-center mt-3">
                                <p>Нет аккаунта? <span onClick={() => {navigate('/signup')}} className='text-indigo-600 cursor-pointer'>Зарегистрироваться</span> </p>
                            </div>
                        </div>
                    </div>
                </div>
